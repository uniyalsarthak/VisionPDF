...
#         # ignore tiny decorative graphics
...
#     t = text.lower().strip()
#     return t.startswith("fig") or t.startswith("figure") or t.startswith("table")
...
#     options.images_scale = 2.5   # higher quality + still fast
#     options.generate_picture_images = True
#     options.generate_page_images = False
#     options.do_ocr = False

#     # 🔥 SPEED BOOST SETTINGS
#     options.layout_options.do_layout_analysis = False
#     options.table_structure_options.do_table_structure = False
...
#                 nxt, _ = items[j]
#                 if isinstance(nxt, TextItem) and looks_like_caption(nxt.text):
...
#     """
#     Creates a Word document from image results.
...
# HUGE SPEED BOOST — avoids reloading models every PDF
# =========================================================
